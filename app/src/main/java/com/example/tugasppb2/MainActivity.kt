                ...
                if (isEmpty(getNama) || isEmpty(getNip) || isEmpty(getJkel) || isEmpty(getJabatan)) {
                    ...
                    getReference.child("Admin").child(getUserID).child("DataKaryawan").push()
                        ...
                        .addOnCompleteListener(this) {
                            ...
                            Toast.makeText(this@MainActivity, "Data Anda Sudah Tersimpan", Toast.LENGTH_SHORT).show()
                        }
                }
            }
            R.id.btn_logout -> {
                AuthUI.getInstance()
                    ...
                    .addOnCompleteListener(object : OnCompleteListener<Void> {
                        override fun onComplete(p0: Task<Void>) {
                            Toast.makeText(this@MainActivity, "Anda Logout", Toast.LENGTH_SHORT).show()
